    ...
    if (general.emptyCheck(groupName)) {
        ...
        careatorChatGroup.insert(insertObj, function (err, groupCreate) {
            if (err) {
                ...
                var obj = {
                    "group_id": groupCreate.ops[0]._id,
                    "groupName": groupName,
                    "groupMemebers": groupMembers_ids,
                    "chats": [{
                        "senderId": "autoGenerated",
                        "senderName": "autoGenerated",
                        "message": "You are invited to " + groupName + " group",
                        "sendTime": date
                    }],
                    "timeStamp": date
                }
...
module.exports.getChatRecordForGroup_byId = function (req, res) {
