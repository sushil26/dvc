    ...
    careatorMaster.update({
        ...
        if (err) {
            ...
            var mailOptions = {
                ...
                to: req.body.email,
                subject: 'VC4ALL Credential',
                 html: "<table style='border:10px solid gainsboro;'> <thead style='background-image: linear-gradient(to bottom, #00BCD4 0%, #00bcd40f 100%);'> <tr> <th> <h2>Greetings from VC4ALL</h2> </th> </tr> </thead> <tfoot style=background:#00bcd4;color:white;> <tr><td style=padding:15px;><p><p>Have a seamless chat,</p><b>Team-VC4ALL</b></p></td> </tr> </tfoot> <tbody> <tr> <td> <b>Hey!</b> </td> </tr> <tr> <td>You just got a video call invitation from " + req.body.sessionHost + ".<br> Join the call by clicking on the link below:<br><br> <a href=" + req.body.url + " style=background:gainsboro;>URL: Click Me</a><br> Enter the Email ID to which this mail is received <br> Enter the One Time Password <br> <p> <b>Password :</b> " + password + "</p> <b>Note:</b> This is a system generated password which will be lapsed once the current session is over. </td> </tr> </tbody> </table>"
