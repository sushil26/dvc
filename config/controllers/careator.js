    ...
    careatorMaster.update({
        ...
        if (err) {
            ...
            var mailOptions = {
                ...
                to: req.body.email,
                subject: 'VC4ALL Credential',
                 html: "<link rel='stylesheet' type='text/css' href='//fonts.googleapis.com/css?family=Lato'/> <table style='border:5px solid gainsboro;border-top-left-radius: 15px;border-bottom-right-radius: 15px;font-family:lato !important;'> <thead style='background: linear-gradient(to bottom, #00BCD4 0%, #00bcd40f 100%);border-top-left-radius: 15px;'> <tr> <th> <h2>Greetings from VC4ALL</h2> </th> </tr> </thead> <tbody> <tr> <td> <b>Hey!</b> </td> </tr> <tr> <td>You just got a video call invitation from <span style='color:blue;'>" + req.body.sessionHost + "</span>. <br> Join the call by clicking on the URL below: <br> <br><b>URL:</b><a href=" + req.body.url + " style=color:dodgerblue;>Conference Link</a> <br> Enter the Email ID to which this mail is received. <br> Enter this One Time Password: <br> <p> <b>Password :</b> " + password + "</p> <b>Note:</b> This is a system generated password which will be lapsed once the current session is over. </td> </tr> <tr style='background: linear-gradient(to bottom, #00bcd40f 0%, #00BCD4 100%);border-bottom-right-radius: 15px;'> <td style=padding-top:4px;padding-bottom:4px> <p>Have a seamless chat, <br> <b>Team-VC4ALL</b> </p> </td> </tr> </tbody> </table>"
