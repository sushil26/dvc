                    ...
                    careatorEmp.update({ "email": email }, { $set: { "password": password } }, function (err, data) {
                        if (err) {
                            ...
                            var mailOptions = {
                                ...
                                html:"<table><thead><tr><th><h2>VC4ALL</h2></th></tr></thead><tbody><tr><td><b>Dear Careator Employee, </b></td></tr><tr><td>Please note, Your email Id is verified successfully, you can access the below link by using given password.<p>Password: "+password+"</p></td></tr> <tr><p><p>Regards</p><b>Careator Technologies Pvt. Ltd</b></p></tr></tbody></table>"
