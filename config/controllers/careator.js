                    ...
                    careatorEmp.update({ "email": email }, { $set: { "password": password } }, function (err, data) {
                        if (err) {
                            ...
                            var mailOptions = {
                                ...
                                html:
                                "<html><head><p><b>Dear Careator Employee, </b></p><p>Please note, Your email Id is verified successfully,  you can access the below link by using given password.<p>Here your link <a href=https://norecruits.com/careator>https://norecruits.com/careator</a><p>Password: </p>"+password+"</p><p>Regards</p><p><b>Careator Technologies Pvt. Ltd</b></p></head><body></body></html>"
