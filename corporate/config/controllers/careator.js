            ...
            if (err) {
                ...
                if (findData.length > 0) {
                    if (findData[0].password == password) {
                        careatorMaster.find({"instantConf.sessionURL": url },{'instantConf.$':1,"firstName":0,"lastName":0,"empId":0,"email":0,"password":0,"Designation":0, "sessionRandomId":0,"videoRights":0,"chatRights":0,"orgId":0,"status":0,"chatStatus":0,"restrictedTo":0,"profilePicPath":0,"login":0,"logout":0,"loginType":0,"invite":0  }).toArray(function (err, sessionURLFind) {
