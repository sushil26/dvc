            ...
            if (err) {
                ...
                if (findData.length > 0) {
                    if (findData[0].password == password) {
                        careatorMaster.find({"instantConf.sessionURL": url },{"_id":0 ,"firstName":0,"lastName":0 ,	"empId":0, "email":0, "password":0 ,"Designation":0 ,"sessionRandomId":0,"videoRights":0 ,"chatRights":0 ,"orgId":0,"instantConf":0 ,"status":0 ,"chatStatus":0,
