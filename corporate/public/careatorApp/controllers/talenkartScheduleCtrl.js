careatorApp.controller('talenkartScheduleCtrl', function ($scope, $q, $timeout, $rootScope, $state, $rootScope, $compile, $window, $filter, careatorHttpFactory, careatorSessionAuth, moment, calendarConfig, $uibModal, SweetAlert, $interval) {
    console.log("talenkartScheduleCtrl==>");
