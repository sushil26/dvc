careatorApp.controller('talenkartSchedule_historyEventCtr', function ($scope, $rootScope, $interval, careatorHttpFactory, careatorSessionAuth, $uibModal) {
    console.log("talenkartSchedule_historyEventCtr==>");
    $scope.events = [];
