careatorApp.controller('talenkartSchedule_upcomingCtr', function ($scope, $rootScope, $state, $window, careatorHttpFactory, $uibModal, $filter, careatorSessionAuth, SweetAlert, $interval) {
    console.log("talenkartSchedule_upcomingCtr==>");
