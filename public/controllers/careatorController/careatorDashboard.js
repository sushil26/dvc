app.controller('careatorDashboard', function ($scope, $rootScope, $timeout, $window, httpFactory, $uibModal, sessionAuthFactory, $filter, $timeout) {

    console.log("careatorDashboard==>");
