    ...
    if (userName != null) {
        if (msg != null) {
            ...
            if (msg) {
                ...
                signaling_socket.emit('textMsg', { 'message': msg, 'userId': peerNew_id, 'queryLink': queryLink, 'timeLink': timeLink, 'userName': userName, "email": localStorage.getItem('careatorEmail') });
