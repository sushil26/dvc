...
function startSession(id, date) {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      window.location.href = "https://norecruits.com/careator_conf_RND/" + id + "/" + date;
    },
    error: function (err) {
      console.log("err: " + JSON.stringify(err));
      console.log("err.responseText: " + JSON.stringify(err.responseText));
...
signaling_socket.on("connect", function () {
  ...
  signaling_socket.on("message", function (config) {
    ...
    document.getElementById("linkToShare").setAttribute("href", "https://norecruits.com/careator_conf_RND/" + peerNew_id + "/" + date);
    document.getElementById("linkToShare").innerHTML = "https://norecruits.com/careator_conf_RND/" + peerNew_id + "/" + date;
    // } else {
