  ...
  // multiStreamRecorder.start(3000);
    // video.addEventListener('loadedmetadata', function () {
      ...
      function appendLink(blob) {
        ...
        a.target = '_blank';
        a.innerHTML = 'Open Recorded ' + (blob.type == 'audio/ogg' ? 'Audio' : 'Video') + ' No. ' + (index++) + ' (Size: ' + bytesToSize(blob.size) + ') Time Length: ' + getTimeLength(5*5*1000);
     ...
     multiStreamRecorder.start(3*3*1000);
